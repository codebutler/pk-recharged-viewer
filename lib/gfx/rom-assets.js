...
import { FRAME_BY_FACING, MON_FRAME_BY_FACING, OFFSETS, romOffset, romView } from "./rom-offsets.js";
 ...
 * sheet of 6 32x32 frames in stand/walk pairs per direction (see
 * MON_FRAME_BY_FACING). The remaining
...
export function monOverworldSprite(romData, species, facing = "down") {
  ...
  const frame = MON_FRAME_BY_FACING[facing] ?? 0;
